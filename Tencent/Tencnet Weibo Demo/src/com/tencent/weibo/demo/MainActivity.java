		...
		public void onClick(View v){
			...
			switch (v.getId())
			{
    			...
    			case R.id.btnAuthorize:
			        ...
			        intent = new Intent(MainActivity.this, OAuthV1AuthorizeWebView.class);//创建Intent，使用WebView让用户授权
    			...
    			case R.id.btnAPItest:
    				...
    				intent= new Intent(MainActivity.this, WeiBoAPIV1Activity.class);//创建Intent，转到调用Qweibo API的Activity
    				intent.putExtra("oauth",oAuth);
